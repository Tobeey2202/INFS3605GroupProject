...
public class Trail {
    ...
    public static ArrayList<Plant> generatePlantList(){
        ...
        plantList.add(plant);
        plant = new Plant("11", "Macrozamia communis", "Burrawang", "Located outside the Sir Sir John Clancy Auditorium", "Seeds can be removed from mature cones and leached in water for a week, with daily water changes, to remove toxins. The pulp of the seeds can then be made into cakes and roasted over embers.", "Long-lived wattle-tree, potentially reaching 30m, with a dense conical to medium domed canopy.",
                "QLD, NSW","a11_fig");
        plantList.add(plant);
