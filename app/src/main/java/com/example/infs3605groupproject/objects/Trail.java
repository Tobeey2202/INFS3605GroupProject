...
//                "Coastal Eastern Australia","port_jackson_fig");
//        plantList.add(plant);
...
//                "QLD, NSW, VIC","acacia_elata_diagram");
//        plantList.add(plant);
...
//                "QLD, NSW","acacia_elata_diagram");
//        plantList.add(plant);
//        plant = new Plant("4", "Brachychiton", "Illawarra Flame Tree", "Lower Campus", "Seeds can be extracted from seed pods, ground and eaten. Seeds are about 18 per cent protein, 25 per cent fat and high in zinc and magnesium.  the sturdy fibre of the inner bark can be made into string, dilly bags and f ishing nets.", "Long-lived wattle-tree, potentially reaching 30m, with a dense conical to medium domed canopy.",
//                "QLD, NSW","acacia_elata_diagram");
//        plantList.add(plant);
...
//                "All states","acacia_elata_diagram");
//        plantList.add(plant);
...
//                "QLD, NSW, VIC, TAS, SA","acacia_elata_diagram");
//        plantList.add(plant);
...
//                "North coast QLD, NSW","acacia_elata_diagram");
//        plantList.add(plant);
...
//                "QLD, NSW, VIC, TAS","acacia_elata_diagram");
//        plantList.add(plant);
...
//                "NT, QLD, NSW, VIC","acacia_elata_diagram");
//        plantList.add(plant);
...
//                "QLD, NSW","acacia_elata_diagram");
//        plantList.add(plant);
//        plant = new Plant("16", "Ficus watkinsiana", "Strangling Fig", "Lower Campus", "the succulent figs are a popular and tasty fruit.", "Long-lived wattle-tree, potentially reaching 30m, with a dense conical to medium domed canopy.",
//                "NE QLD, NORTHERN NSW","acacia_elata_diagram");
//        plantList.add(plant);
...
//                "Coastal QLD and NSW","acacia_elata_diagram");
//        plantList.add(plant);
...
//                "NSW, VIC, TAS","acacia_elata_diagram");
//        plantList.add(plant);
...
//        plantList.add(plant);
        ...
        plant = new Plant("24", "Eupomatia laurina", "Bolwarra", "Opposite of UNSW Bookshop", "the sticky sweep pulp coating the seeds is edible.", "Large tree of the family Malvaceae and is famous for the bright red bell-shaped flowers that often cover the whole tree when it is leafless.",
                "Coastal QLD, NSW and VIC", "illawarra_flame_tree");
        plantList.add(plant);
        return plantList;
    }
